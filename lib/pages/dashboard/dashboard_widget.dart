...
class _DashboardWidgetState extends State<DashboardWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.userResult =
          await appwrite_authentication_kit_h7mvam_actions.getCurrentUser(
        appwrite_authentication_kit_h7mvam_app_state.FFAppState()
            .appwriteConfig,
      );
      appwrite_authentication_kit_h7mvam_app_state.FFAppState().appwriteConfig =
          _model.userResult!.toString();
      safeSetState(() {});
    });
